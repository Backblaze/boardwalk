...
def init_runner(**kwargs):  # -> Transmitter | Worker | Processor | Runner:
    """
...
def run(**kwargs: runnerKwargs) -> Runner:
    """
...
def run_async(**kwargs):  # -> tuple[Thread, Transmitter | Worker | Processor | Runner]:
    """
...
def init_command_config(executable_cmd, cmdline_args=..., **kwargs):  # -> Runner:
    """
    Initialize the Runner() instance
...
def run_command(
    ...
    input_fd: typing.TextIO,
    envvars: dict[str, str | int],
...
def run_command_async(
    executable_cmd, cmdline_args=..., **kwargs
):  # -> tuple[Thread, Runner]:
    """
...
def get_ansible_config(
    action, config_file=..., only_changed=..., **kwargs
):  # -> tuple[str, str]:
    """
...
def get_role_list(
    collection=..., playbook_dir=..., **kwargs
):  # -> tuple[Any | str, str]:
    """
...
def get_role_argspec(
    role, collection=..., playbook_dir=..., **kwargs
):  # -> tuple[Any | str, str]:
    """
